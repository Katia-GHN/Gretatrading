 ...
 */
final class Version20231027141750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, letrader_id INT DEFAULT NULL, la_action_id INT DEFAULT NULL, datetransaction DATETIME NOT NULL, quantite INT NOT NULL, INDEX IDX_723705D1F2FDF806 (letrader_id), INDEX IDX_723705D1F4F39740 (la_action_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
